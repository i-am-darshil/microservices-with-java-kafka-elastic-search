...
import com.microservices.demo.exceptions.TwitterToKafkaServiceException;
...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    @Autowired
    public MockKafkaStreamRunner(TwitterToKafkaServiceConfigData twitterToKafkaServiceConfigData, TwitterStatusListener twitterKafkaStatusListener) {
    ...
    private void sleep(long sleepTimeMs) throws TwitterToKafkaServiceException {
        try {
